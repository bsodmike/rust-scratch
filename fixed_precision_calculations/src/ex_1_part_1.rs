...
mod tests {
    ...
    fn simulate_rounding_failure() {
        ...
        // thread 'ex_1::tests::simulate_rounding_failure' panicked at src/ex_1_part_1:37:9:
    ...
    #[test]
    fn simulate_rounding_failure_without_type_conversion() {
        let average: f64 = 56098.9;
        let r = D128::from(average) / D128::from(100);

        assert_eq!(format!("{:.2}", r), "560.99");
    }
}
